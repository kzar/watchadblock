...
test_picreplacement = function() {
  ...
  assert_eq(picreplacement._fit(pic1, t1), expect1);
  assert_eq(picreplacement._fit(pic1, t2), expect2);
  assert_eq(picreplacement._fit(pic1, t3), expect3);
  ...
  assert_eq(picreplacement._fit(pic, t4), expect4);
