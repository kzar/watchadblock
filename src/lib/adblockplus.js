...
require.scopes["icon"] = (function()
{
  ...
  function renderFrames(notificationType)
  {
    ...
    return Promise.all([loadImage("icons/abp-19.png"), loadImage("icons/abp-19-whitelisted.png"), loadImage("icons/abp-19-notification-" + notificationType + ".png"), loadImage("icons/abp-38.png"), loadImage("icons/abp-38-whitelisted.png"), loadImage("icons/abp-38-notification-" + notificationType + ".png")]).then(function(images)
    {
      ...
      for (var _loopIndex56 = 0; _loopIndex56 < [false, true].length; ++_loopIndex56)
      {
        var whitelisted = [false, true][_loopIndex56];
        for (var i = 0, opacity = 0; i <= 10; opacity = ++i / 10)
        {
          var imageData = {};
          for (var _loopIndex57 = 0; _loopIndex57 < [19, 38].length; ++_loopIndex57)
          {
            var size = [19, 38][_loopIndex57];
            canvas.width = size;
            canvas.height = size;
  ...
  function animateIcon(notificationType, frames)
  {
    ...
    }, function(pages)
    {
      ...
      var interval = setInterval(function()
      {
        ...
        {
          for (var _loopIndex58 = 0; _loopIndex58 < pages.length; ++_loopIndex58)
          {
            var page = pages[_loopIndex58];
...
{
  var exports = {};
  var _tempVar59 = require("icon");
  var startIconAnimation = _tempVar59.startIconAnimation;
  var stopIconAnimation = _tempVar59.stopIconAnimation;
  var Utils = require("utils").Utils;
  ...
  function openNotificationLinks()
  {
    ...
    {
      for (var _loopIndex60 = 0; _loopIndex60 < activeNotification.links.length; ++_loopIndex60)
      {
        var link = activeNotification.links[_loopIndex60];
...
require.scopes["subscriptionInit"] = (function()
{
  "use strict";
  var exports = {};
  var _tempVar61 = require("subscriptionClasses");
  var Subscription = _tempVar61.Subscription;
  var DownloadableSubscription = _tempVar61.DownloadableSubscription;
  var SpecialSubscription = _tempVar61.SpecialSubscription;
  var FilterStorage = require("filterStorage").FilterStorage;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var Prefs = require("prefs").Prefs;
  ...
  {
    for (var _loopIndex62 = 0; _loopIndex62 < FilterStorage.subscriptions.length; ++_loopIndex62)
    {
      var subscription = FilterStorage.subscriptions[_loopIndex62];
  ...
  {
    var subscriptions = [];
    for (var _loopIndex63 = 0; _loopIndex63 < Prefs.additional_subscriptions.length; ++_loopIndex63)
    {
      var url = Prefs.additional_subscriptions[_loopIndex63];
  ...
  function finishInitialization(subscriptions)
  {
    ...
    for (var _loopIndex64 = 0; _loopIndex64 < subscriptions.length; ++_loopIndex64)
    {
      var subscription = subscriptions[_loopIndex64];
      FilterStorage.addSubscription(subscription);
...
require.scopes["requestBlocker"] = (function()
{
  ...
  var RegExpFilter = _tempVar65.RegExpFilter;
  var BlockingFilter = _tempVar65.BlockingFilter;
  var Subscription = require("subscriptionClasses").Subscription;
  var defaultMatcher = require("matcher").defaultMatcher;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var Prefs = require("prefs").Prefs;
  var _tempVar66 = require("whitelisting");
  var checkWhitelisted = _tempVar66.checkWhitelisted;
  var getKey = _tempVar66.getKey;
  var _tempVar67 = require("url");
  var stringifyURL = _tempVar67.stringifyURL;
  var extractHostFromFrame = _tempVar67.extractHostFromFrame;
  var isThirdParty = _tempVar67.isThirdParty;
  var port = require("messaging").port;
  var devtools = require("devtools");
  ...
  port.on("filters.collapse", function(message, sender)
  {
    ...
    for (var _loopIndex68 = 0; _loopIndex68 < message.urls.length; ++_loopIndex68)
    {
      var url = message.urls[_loopIndex68];
...
require.scopes["popupBlocker"] = (function()
{
  ...
  var defaultMatcher = require("matcher").defaultMatcher;
  var BlockingFilter = require("filterClasses").BlockingFilter;
  var _tempVar69 = require("url");
  var stringifyURL = _tempVar69.stringifyURL;
  var isThirdParty = _tempVar69.isThirdParty;
  var extractHostFromFrame = _tempVar69.extractHostFromFrame;
  ...
  function getFrame(tabId, processId, frameId, callback)
  {
    ...
    {
      var _tempVar70 = details;
      var url = _tempVar70.url;
      var parentFrameId = _tempVar70.parentFrameId;
      var frame = {
        url: new URL(url),
        parent: null
      };
