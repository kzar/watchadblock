...
//         step:number - this value coincides with the step numbers of the
//           wizard. Each step changes the webpage's appearence and will
//           therefore rely on a specific css made by this function. For example:
//             0: "block an ad" (z-index)
//             1: "figure out what to block" (opacity)
//             2: "what makes this an ad" (display)
function preview(selector, step) {
  ...
  switch (step) {
  case 0:
    var d = "body .adblock-blacklist-page0 ";
    // Raise Clickwatcher._ui layers.
    css_preview.innerText = d + ", " + d + " * {z-index:10000000!important;} " +
    // Override all other zIndexes.
      selector + " {z-index:auto!important;}";
    break;
  case 1:
...
BlacklistUi.prototype.handle_change = function() {
  ...
  this._redrawPage1();
  this._redrawPage2();
  preview(selector_from_elm(this._chain.current()), 1);
}
...
BlacklistUi.prototype._build_page1 = function() {
  ...
  btns[translate("buttonlooksgood")] = 
      function() {
        ...
        preview($('#summary', that._ui_page2).text(), 2);
      }
...
BlacklistUi.prototype._build_page2 = function() {
  ...
  btns[translate("buttonback")] = 
      function() {
        ...
        preview(selector_from_elm(that._chain.current()), 1);
      }
