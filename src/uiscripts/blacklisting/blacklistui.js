...
function preview(selector) {
  ...
  // Raise the UI.
  css_preview.innerText += " " + d + " {z-index:11000000 !important;}";
...
BlacklistUi.prototype.handle_change = function() {
  ...
  this._redrawPage1();
  this._redrawPage2();
  preview.call(this, selector_from_elm(this._chain.current()));//1
}
...
BlacklistUi.prototype._build_page1 = function() {
  ...
  page.dialog({
      ...
      open: function() {
        ...
        preview.call(that, selector_from_elm(that._chain.current()));
      },
      close: function() {
        preview.call(that, null);
        that._onClose();
...
BlacklistUi.prototype._build_page2 = function() {
  ...
  page.dialog({
      ...
      open: function() {
        ...
        preview.call(that, $('#summary', that._ui_page2).text());
      },
      close: function() {
        preview.call(that, null);
        that._onClose();
...
BlacklistUi.prototype._redrawPage2 = function() {
  ...
  for (var i = 0; i < attrs.length; i++) {
    ...
    checkbox.find("input").change(function() {
      updateFilter();
      preview.call(that, $("#summary", that._ui_page2).text());//2
    });
